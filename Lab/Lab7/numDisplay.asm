...
; Lab excercise.
;
; The code below displays an 8-bit unsigned integer on LCD. 
;
; Originally written by Mr. Jason Corless in 2015
; and modified by Victoria Li on October 26, 2018
...
.org 0
	...
	place your code here and remove this line which generates an error
